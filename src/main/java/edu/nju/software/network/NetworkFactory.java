...
public class NetworkFactory {
    ...
    public static SubNetworkInterface generateSubNetwork(NetworkParameter networkParameter) {
        ...
        for (AgentData agent : agentDatas) {
            ...
            network.addAgent(MultiLevelAgentFactory.newMultiLevelAgent(agentParameter));
        }
    ...
    public static SubNetworkInterface generateTrueSubNetwork(NetworkParameter networkParameter,int maxCount){
